...
$GitBasePath = 'C:\Users\RiteshJha\OneDrive - LPPI\MyData\Study\AzureDevopsArmBasics\Repo\LeveragingARMTemplates'
$RsgName = 'On-prem'
#Deploy simple template creating a storage account
New-AzResourceGroupDeployment -ResourceGroupName $RsgName `
...
New-AzResourceGroupDeployment -ResourceGroupName On-prem `
